...
static void sensors_updatePedalBox(SensorData* sensorData, VCUModelInputs *vcuModelInputs)
{
  ...
  sensorData->pedalBox.appsVoltage1 = vcuModelInputs->apps.pedal1Voltage;
  sensorData->pedalBox.appsVoltage2 = vcuModelInputs->apps.pedal2Voltage;
